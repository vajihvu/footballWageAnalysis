...
## Project Overview
  ...
  The goal is to identify patterns and correlations between pay and performance, and to assess wage efficiency across different player positions.
...
## Analysis Performed
  ...
  Descriptive Statistics: Calculating averages, distributions and ratios.
...
## Key Insights
  ...
  Some players show disproportionately high wages compared to performance output.
...
## Future Enhancements
  ...
  Fetch real world data from public APIs (FBref or Sofifa) for live analysis.
